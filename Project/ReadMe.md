...
11. Dodanie możliwości ustawiania limitów budżetowych w panelu prawym + wyświetlanie komunikatu o przekroczeniu limitu.
12. Dodawanie, edycja i usuwanie transakcji
13.
14. Możliwość oznaczania transakcji jako cykliczne (np. abonamenty, czynsz)(X)
